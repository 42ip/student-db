...
class examInsert extends StatefulWidget {
  @override
  _examInsertState createState() => _examInsertState();
}

class _examInsertState extends State<examInsert> {
            ...
            RaisedButton(
              ...
              onPressed: () {
                ...
                final snackbar = SnackBar(
                  backgroundColor: Hexcolor('#1B3B59'),
                  content: Text(
                      '${_subjectIdController.text} on ${_dateController.text} has been added.'),
  ...
  void _performInsert() async {
    ...
    var uriResponse = await client.post('http://34.224.4.55:8080/createExam',
